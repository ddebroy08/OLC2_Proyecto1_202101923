...
public class LexicalErrorListener : BaseErrorListener, IAntlrErrorListener<int>
{
    ...
    {
        Console.WriteLine($"Error Lexico en línea {line} columna {charPositionInLine}: {msg}");
        throw new ParseCanceledException($"Error Lexico en línea {line}:{charPositionInLine} - {msg}");
    }
}
